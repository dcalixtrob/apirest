package org.techtestbackend.notas.swagger;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).apiInfo(apiInfo())
				...
				.apis(RequestHandlerSelectors.basePackage("org.techtestbackend.notas.controller"))
				.paths(PathSelectors.any()).build();
	}

	private ApiInfo apiInfo() {
		return new ApiInfo("REST API Notas", "Servicios Rest para el sistemas de notas", "API Rest Notas", "",
				new Contact("David Calixtro", "", "cbdavid007@gmail.com"), "License", "", Collections.emptyList());
	}
